$(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data.form_is_valid) {
          $("#datatable-responsive tbody").html(data.html_profile_list);
  ...
  // Update profile
  $("#datatable-responsive").on("click", ".js-update-profile", loadForm);
  $("#modal-profile").on("submit", ".js-profile-update-form", saveForm);

  // Delete profile
  $("#datatable-responsive").on("click", ".js-delete-profile", loadForm);
